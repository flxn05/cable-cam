...
<body>
  <main>
    ...
    <div class="button-container">
      ...
      <div>
         <button onclick="preset()" class="btn-row" id="preset">Losfahren</button>
      </div>
      <input type="text" id="meter" placeholder="How wide to drive">    
      <input type="text" id="speed" placholder="How faste to drive">
...
<div class="quarterspace"></div>
  ...
  <script>
    ...
    function preset(){
      ...
      xhr.open('GET', `/pre?=${meters}=${speed}=`, true);
      xhr.send();
    }
